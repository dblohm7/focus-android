...
class DownloadFileTest {
    ...
    fun downloadNotificationTest() {
        val downloadPageUrl = webServer!!.url(TEST_PATH).toString()
        val downloadFileName = "download.jpg"
        val downloadNotification = "Download completed"
        ...
        TestHelper.verifySystemNotificationExists(downloadNotification)
    }
